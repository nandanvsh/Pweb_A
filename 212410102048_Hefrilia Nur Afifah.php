...
<body style="font-family:calibri;">
    <h1 style= "padding:18px; text-align:center;">Praktikum 03 - Introduction to PHP </h1>
    <?php for ($i = 1; $i <= 100; $i++) : ?>
            <?php if ($i % 3 == 0) : ?>
                <table border="1" align="center" cellspacing="0" cellpadding="5px" width="50%" style="background-color:black; color:white;">
                    <tr>
