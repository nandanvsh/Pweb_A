...
<body style="font-family: Calibri; font-size: 30px; margin: 30px; font-weight:500;">
<h2 style="padding-top:5px; padding-bottom:35px;">Praktikum 05 - PHP Objects </h2>
    <?php
        class lingkaran{
            public $jejari;
    ...
    <h3 style = "margin:30px; text-align: center; padding:80px;"> 212410102048 - Hefrilia Nur Afifah</h3>
</body>
</html>